...
namespace ProductAppsTest
{
    public class UnitTest1
    {
        ...
        public void test_Orange()
        {
            ...
            // IWebElement ap = driver.FindElement(By.Id("learn"));
            IWebElement FeedCreate = driver.FindElement(By.XPath("/html/body/div/table/tbody/tr[4]/td[1]"));
            string text = FeedCreate.Text;
        ...
        public void test_Orange_Price()
        {
            ...
            // IWebElement ap = driver.FindElement(By.Id("learn"));
            IWebElement FeedCreate = driver.FindElement(By.XPath("/html/body/div/table/tbody/tr[4]/td[2]"));
            string text = FeedCreate.Text;
        ...
        public void test_Orange_Desc()
        {
            ...
            // IWebElement ap = driver.FindElement(By.Id("learn"));
            IWebElement FeedCreate = driver.FindElement(By.XPath("/html/body/div/table/tbody/tr[4]/td[3]"));
            string text = FeedCreate.Text;
